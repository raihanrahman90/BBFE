            ...
            <div className="admin-card h-100 w-100">
                <div className="admin-card-header">
                    ...
                    <div className="admin-button-container">
                        <input type="number" name="minPrice" placeholder="Minimal Harga" value={minPrice} onChange={(e)=>setMinPrice(e.target.value)} className="without-label"/>
                        <input type="number" name="maxprice" placeholder="Maximal Harga" value={maxPrice} onChange={(e)=>setMaxPrice(e.target.value)} className="without-label"/>
                        <input type="text" name="name" placeholder="Filter Nama" value={name} onChange={(e)=>setName(e.target.value)} className="without-label"/>
